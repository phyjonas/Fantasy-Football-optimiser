# Class to set up the MIP, solve it and write the results into a csv file (a copy of the DraftKings salary file)
...
class Optimiser:
    ...
    def mip(self, max_per_team, risk_missing, r):
        # Get Data and match the two soruces
        data = Data()
        ...
        # Number of players per position constraint
        ...
        # limit player of the same team per lineup
        for t in data.Teams:
    ...
    def solve(self, print_out=False):
        self.prob.solve()
        self.selection = []
